...
class DSLParser:
    ...
    def parse_function_names(self, line: str) -> FunctionNames:
        ...
        if not clinic.is_legal_py_identifier(full_name):
            fail(f"Illegal function name: {full_name!r}")
        if not clinic.is_legal_c_identifier(c_basename):
    ...
    def state_modulename_name(self, line: str) -> None:
        ...
        if equals:
            ...
            if clinic.is_legal_py_identifier(existing):
                # we're cloning!
    ...
    def format_docstring(self) -> str:
        ...
        docstring = "\n".join(lines)
        return clinic.linear_format(docstring,
                                       signature=signature,
