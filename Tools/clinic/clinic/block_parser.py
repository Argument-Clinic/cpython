...
import clinic
from clinic import fail, ClinicError
...
class BlockParser:
    ...
    def __init__(
        ...
        assert _ == '{dsl_name}'
        self.find_start_re = clinic.create_regex(before, after,
                                                    whole_line=False)
        self.start_re = clinic.create_regex(before, after)
        self.verify = verify
    ...
    def parse_clinic_block(self, dsl_name: str) -> Block:
        ...
        if self.last_dsl_name == dsl_name:
            ...
            assert _ == '{arguments}'
            checksum_re = clinic.create_regex(before, after, word=False)
        ...
        if arguments:
            ...
            if self.verify:
                ...
                computed = clinic.compute_checksum(output, len(checksum))
