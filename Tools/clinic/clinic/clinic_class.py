...
import clinic
from clinic import fail, warn
from clinic.function import (
    Module, Class, ClassDict, ModuleDict, Function)
from clinic.block_parser import Block, BlockParser
from clinic.crenderdata import Include
from clinic.clanguage import CLanguage
from clinic.block_printer import (
    BlockPrinter)
from clinic.block_printer import (
            ...
            if output:
                ...
                if destination.type == 'file':
                    ...
                    printer_2.print_block(block,
                                          ...
                                          limited_capi=self.limited_capi,
                                          header_includes=self.includes)
                    clinic.write_file(destination.filename,
...
# Must be imported at the end to solve inter-dependency
from clinic.parsers import parsers
