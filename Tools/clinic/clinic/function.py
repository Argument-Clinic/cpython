...
if TYPE_CHECKING:
    from clinic.converter import CConverter
    from clinic.converters import self_converter
    from clinic.return_converters import CReturnConverter
    from clinic.clinic_class import Clinic

from clinic import VersionTuple, unspecified
