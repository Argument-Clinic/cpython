...
import clinic
from clinic import fail, warn, Sentinels, unspecified, VersionTuple
from clinic.formatting import (
    docstring_for_c_string, format_escape, linear_format, wrap_declarations,
    normalize_snippet, pprint_words, wrapped_c_string_literal,
    suffix_all_lines, indent_all_lines)
from clinic.crenderdata import CRenderData, TemplateDict
from clinic.cpp import Monitor
from clinic.converters import (
    self_converter, object_converter,
    )
from clinic.language import Language
from clinic.converters import (
    defining_class_converter)
from clinic.function import (
    Module, Class, Function, Parameter,
    GETTER, SETTER, METHOD_INIT, METHOD_NEW)
from clinic.option_groups import permute_optional_groups
